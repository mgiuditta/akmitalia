...
- **Do** far seguire all'anello di fuoco il valore della superficie (`--anello`), non il colore dell'elemento: su un bottone rosso l'etichetta è bianca, e un anello bianco a 3px di offset cade sul bianco della sezione.
