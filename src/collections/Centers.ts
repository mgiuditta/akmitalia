...
const validateTime = (value: unknown) =>
  !value || (typeof value === 'string' && TIME_PATTERN.test(value)) || 'Usa il formato HH:MM (es. 20:00).'
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          type: 'row',
          fields: [
            { name: 'oraInizio', type: 'text', required: true, label: 'Dalle', validate: validateTime },
            { name: 'oraFine', type: 'text', required: true, label: 'Alle', validate: validateTime },
          ],
        },
        {
          name: 'docenti',
