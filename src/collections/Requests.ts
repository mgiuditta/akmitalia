...
export const Requests: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      type: 'row',
      fields: [
        { name: 'cognome', type: 'text', required: true, label: 'Cognome', admin: readOnly },
        { name: 'nome', type: 'text', required: true, label: 'Nome', admin: readOnly },
      ],
    },
    {
      type: 'row',
      fields: [
        { name: 'email', type: 'email', required: true, label: 'Email', admin: readOnly },
        { name: 'telefono', type: 'text', label: 'Telefono', admin: readOnly },
      ],
    },
    { name: 'dataNascita', type: 'date', label: 'Data di nascita', admin: readOnly },
    {
      name: 'sede',
      type: 'relationship',
      relationTo: 'sedi',
    ...
    { name: 'messaggio', type: 'textarea', label: 'Messaggio', admin: readOnly },
    {
      type: 'row',
      fields: [
        {
        ...
        { name: 'consensoAt', type: 'date', label: 'Data consenso', admin: readOnly },
      ],
    },
  ],
}
