...
Una riga di programmazione settimanale di un centro tecnico: una disciplina, i giorni in cui si tiene, l'ora di inizio e di fine. Un centro ha piu' orari; un orario appartiene a un solo centro.
